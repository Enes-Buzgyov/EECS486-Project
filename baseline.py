...
# 1. Data Collection
data_folder = "data"
csv_file = "cleaned_Playboi Carti_comments.csv"
...
plt.tight_layout()
tsne_file_path = os.path.join(output_folder, f"{artist_name}_tsne_visualization.png")
...
plt.tight_layout()
graph_file_path = os.path.join(output_folder, f"{artist_name}_graph_visualization.png")
